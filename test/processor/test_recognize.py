...
#  from ocrd_processor_tesserocr.recognize import TesserocrRecognize
...
class TestTesserocrRecognize(TestCase):
    ...
    def runTest(self):
        ...
        workspace.save_mets()
        #  TODO takes too long
        #  TesserocrRecognize(workspace, inputGrp="OCR-D-SEG-LINE", outputGrp="OCR-D-OCR-TESS").process()
        workspace.save_mets()
